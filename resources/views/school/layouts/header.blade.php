                                ...
                                <li class="nav-item dropdown">
                                    <a href="#account_menu"
                                       ...
                                       data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light">{{ Session::get('school')['name'] }}</span>
                                        </span>
                                        <img src="{{asset('storage/images/' .Session::get('school')['logo'])}}"
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-item-text dropdown-item-text--lh">
                                            ...
                                            <div class="text-muted">{{ Session::get('school')['name'] }}</div>
                                        ...
                                        <a class="dropdown-item"
                                           href="#"><i class="material-icons">exit_to_app</i> Logout</a>
