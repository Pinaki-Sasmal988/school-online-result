                                            ...
                                            <div class="py-2">
                                                ...
                                                <div class="dropdown-item d-flex">
                                                    <div class="mr-3">
                                                        <div class="avatar avatar-sm"
                                                             style="width: 32px; height: 32px;">
                                                            <img src="{{asset('assets/admin/images/256_daniel-gaffey-1060698-unsplash.jpg')}}"
                                                                 alt="Avatar"
                                                                 class="avatar-img rounded-circle">
                                                        </div>
                                                    </div>
                                ...
                                <li class="nav-item dropdown">
                                    <a href="#account_menu"
                                       ...
                                       data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light">{{ Session::get('admin')['email'] }}</span>
                                        </span>
                                        <img src="{{asset('assets/img/ardaylogo.png')}}"
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-item-text dropdown-item-text--lh">
                                            ...
                                            <div class="text-muted">{{ Session::get('admin')['email'] }}</div>
                                        ...
                                        <a class="dropdown-item"
                                           href="{{route('adminLogout')}}"><i class="material-icons">exit_to_app</i> Logout</a>
